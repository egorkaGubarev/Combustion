...
int main()
{
    ...
    const std::string temp_in_name = "C:/Users/gubar/source/repos/burn_stab_flame/eval_no_log/temp-1000-0.785.txt";
    const std::string pos_in_name = "C:/Users/gubar/source/repos/burn_stab_flame/eval_no_log/pos-1000-0.785.txt";
    const std::string par_in_name = "C:/Users/gubar/source/repos/burn_stab_flame/eval_no_log/par-1000-0.785.txt";
